    ...
    public class ConsultantsController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadFile([FromForm] IFormFile file)
        {
            ...
            try
            {
                ...
                var filePath = Path.Combine("image", fileName); // Assurez-vous que le dossier "pdf" existe
        ...
        public IActionResult DownloadPdf(string fileName)
        {
            ...
            var filePath = Path.Combine("image", fileName); // Assurez-vous que le chemin est correct
            ...
            return File(fileBytes, "application/image", fileName);
        }
